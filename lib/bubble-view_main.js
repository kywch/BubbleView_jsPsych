 ...
 * Practice block
 */
function generate_practice_block(prac_img_src, prac_blur_src, prac_seq, img_ext, img_attn = [], bubble_radius = 70) {
 ...
 * Main block
 */
function generate_main_block(main_img_src, main_blur_src, main_seq, img_ext, img_attn = [], bubble_radius = 70) {
    ...
    for (var ii = 0; ii < num_trial; ii++) {
        ...
        */
        ...
        var rating_bubble_phase = {
            ...
            on_finish: function (data) {
                let rating = data.choices[parseInt(data.button_pressed)];
                rating_history.push(rating);
            }
        };
        block_sequence.push(rating_bubble_phase);
